...
#                                    --checkpoint_dir ./checkpoint --sample_dir ./sample --test_dir ./test")
    ...
    Schedule.append("python main.py --generator deeplab --discriminator atrous --phase generate_complete_image \
                                    ...
                                    --datasets_dir D:/Javier/Repo_Noa/SAR2Optical_Project/Datasets/ --image_size_tr 256 --output_stride 16 \
                                    --patch_overlap 0.4 --date both\
                                    --inference_overlap_percentage 0.138 --inference_patch_size 3840 \
                                    --checkpoint_dir ./checkpoint --sample_dir ./sample --test_dir ./test")


elif mode == 'GEE_metrics':
    Schedule.append("python main.py --phase GEE_metrics --dataset_name MG_10m --test_dir E:/Jorge/dataset/ --datasets_dir D:/Javier/Repo_Noa/SAR2Optical_Project/Datasets/")

elif mode == 'Meraner_metrics':
    Schedule.append("python main.py --phase Meraner_metrics --dataset_name MG_10m \
                                    --test_dir D:/Javier/Repo_Noa/SAR2Optical_Project/Datasets/MG_10m \
