...
elif args.dataset_name == 'Para_10m' or args.dataset_name == "MG_10m" or args.dataset_name == "Santarem":
    from model_i import cGAN
...
def actions():
    ...
    with tf1.Session(config=config) as sess:
        ...
        if args.phase == 'train':
            model.train(args)
        # elif args.phase == 'generate_image_patches':
